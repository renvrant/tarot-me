...
import { cardPageCardSelector, cardPageArcanaSelector } from '../../store/card-page.selector';
import {IAppState} from '../../../root/types/app-state.interface';
import CardPage from '../CardPage/CardPage';
import {IArcana} from '../../../tarot-deck/types/arcana.interface';

const CardPageContainer = ({ card, arcana }: { card: ITarotCard, arcana: IArcana }) => {
  return (
    <CardPage card={card} arcana={arcana} />
  );
};
